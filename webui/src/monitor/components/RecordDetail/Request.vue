...
<script>
  ...
  export default {
    ...
    computed  : {
      ...
      protocol() {
        return this.$dc.currentRow.originRequest && this.$dc.currentRow.originRequest.protocol.slice(
          0,
          -1,
        ) || 'http';
      },
    ...
    methods   : {
      toggleQueryMode(e) {
        e.stopPropagation();
        this.queryMode = this.queryMode === 'parsed'
                         ? 'raw'
                         : 'parsed';
      },
      onCopySuccess() {
